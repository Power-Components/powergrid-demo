...
class TailwindStriped extends \PowerComponents\LivewirePowerGrid\Themes\Tailwind
{
    public function table(): Table
    {
        return Theme::table('rounded-lg min-w-full border border-pg-primary-200 dark:bg-pg-primary-600 dark:border-pg-primary-700')
            ->div('my-3 bg-white shadow-lg rounded-lg  transition-height ease-out duration-300')
            ->thead('shadow-sm shadow-sm bg-pg-primary-100 dark:bg-pg-primary-800 border border-pg-primary-200 dark:border-pg-primary-700')
            ->thAction('!font-bold')
            ->tdAction('')
            ->tr('')
            ...
            ->trBody('odd:bg-slate-100 hover:odd:bg-slate-200 border border-pg-primary-100 dark:border-pg-primary-600 hover:bg-pg-primary-50 dark:bg-pg-primary-800 dark:odd:bg-pg-primary-700 dark:odd:hover:bg-pg-primary-700 dark:hover:bg-pg-primary-700')
